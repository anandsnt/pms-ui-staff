    ...
    getThemeMappingList: function () {
        ...
        **/  
        return {
            ...
            'guestweb_freehand_los_angels': [ themeJsRoot + 'app_router_freehand_hotels.js'],
            'guestweb_freehand_chicago': [ themeJsRoot + 'app_router_freehand_hotels.js'],
            'guestweb_freehand_miami': [ themeJsRoot + 'app_router_freehand_hotels.js'],
            'guestweb_freehand_nyc': [ themeJsRoot + 'app_router_freehand_hotels.js'],
