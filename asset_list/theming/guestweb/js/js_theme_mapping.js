...
module.exports = {
	getThemeMappingList : function () {
		...
		return {
			...
			'guestweb_bellagio' 	: [ themeJsRoot + 'app_router_bellagio.js'],
			'guestweb_camby' 	: [ themeJsRoot + 'app_router_camby.js'],
			'guestweb_carillon' 	: [ themeJsRoot + 'app_router_carillon.js'],
			'guestweb_delano' 	: [ themeJsRoot + 'app_router_delano.js'],
			'guestweb_eden' 	 	: [ themeJsRoot + 'app_router_eden.js'],
			...
			'guestweb_nikko' 	: [ themeJsRoot + 'app_router_nikko.js'],
			'guestweb_palms' 	: [ themeJsRoot + 'app_router_palms.js'],
			'guestweb_sanctuary' : [ themeJsRoot + 'app_router_sanctuary.js'],
			'guestweb_vdara' 	: [ themeJsRoot + 'app_router_vdara.js'],
			...
			'guestweb_mandalay_bay' 		: [ themeJsRoot + 'app_router_mandalay_bay.js'],
