...
module.exports = {
  getThemeMappingList : function() {
    ...
    return {
      ...
      'guestweb_bellagio' 	: ['guestweb/**/common_templates/**/MGM/*.html'],
      
      'guestweb_delano' 	: ['guestweb/**/common_templates/**/MGM/*.html'],
      
      'guestweb_vdara' 	: ['guestweb/**/common_templates/**/MGM/*.html'],
      
      'guestweb_mandalay_bay': ['guestweb/**/common_templates/**/MGM/*.html'],
      
      'guestweb_claridge': ['guestweb/**/common_templates/**/**.html'],
