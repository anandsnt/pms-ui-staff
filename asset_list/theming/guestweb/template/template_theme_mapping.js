	...
	getThemeMappingList : function () {
		...
		return {
			...
			'guestweb_atura' 	    :[landingPartials + 'common-black/*.html',
										  ...
										  sharedHtml],
			'guestweb_camby' 		:[ 'guestweb/**/common_templates/partials/checkin/**.html','guestweb/partials/common_templates/partials/checkout/**.html','guestweb/**/common_templates/partials/gwNoOption.html'],
			'guestweb_carillon' 	:[landingPartials + 'Carillon/*.html',
										  ...
										  sharedHtml],
			'guestweb_bellagio' 	:[ 'guestweb/**/common_templates/partials/MGM/*.html','guestweb/partials/common_templates/partials/gwNoOption.html'],
			'guestweb_delano' 		:[ 'guestweb/**/common_templates/partials/MGM/*.html','guestweb/partials/common_templates/partials/gwNoOption.html'],
			'guestweb_vdara' 		:[ 'guestweb/**/common_templates/partials/MGM/*.html','guestweb/partials/common_templates/partials/gwNoOption.html'],
			'guestweb_mandalay_bay'	:[ 'guestweb/**/common_templates/partials/MGM/*.html','guestweb/partials/common_templates//gwNoOption.html'],
			'guestweb_claridge'		:[ 'guestweb/**/common_templates/partials/checkin/**.html','guestweb/partials/common_templates/partials/checkout/**.html','guestweb/**/common_templates/partials/gwNoOption.html'],
			...
			'guestweb_fontainebleau':[landingPartials + 'Montauk/*.html',
										  ...
										  precheckinPartials+'Montauk/*.html', precheckinPartials+'*.html',
										  sharedHtml],
			'guestweb_great_wolf' 	:[ 'guestweb/**/common_templates/partials/checkin/**.html','guestweb/partials/common_templates/partials/checkout/**.html','guestweb/**/common_templates/partials/gwNoOption.html'],
