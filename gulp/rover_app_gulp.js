module.exports = function(gulp, $, options) {
    ...
    //         'inject-rover-less-production-to-template', 'inject-mobile-less-production-to-template',
    ...
    //      'rover-less-production', 'mobile-less-production', 'concat-translation-en-rover-files-dev']);
