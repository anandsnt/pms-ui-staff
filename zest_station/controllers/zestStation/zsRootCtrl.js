sntZestStation.controller('zsRootCtrl', [
	...
	$scope.$on (zsEventConstants.OOS_OFF, function(event) {
        ...
        $scope.setThemeByName = function(theme){
            ...
            console.info('theme for: '+theme+', set!');
            setTimeout(function(){
