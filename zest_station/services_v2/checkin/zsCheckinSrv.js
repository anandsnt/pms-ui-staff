...
sntZestStation.service('zsCheckinSrv', ['$http', '$q', 'zsBaseWebSrv', 'zsBaseWebSrv2', '$rootScope',
    function($http, $q, zsBaseWebSrv, zsBaseWebSrv2, $rootScope) {
        ...
        this.guestDetailsDemoData = { "adult_count": 1, "children_count": 0, "infants_count": 0, "varying_occupancy": false, "primary_guest_details": { "first_name": "mike", "last_name": "mike", "is_vip": false, "image": "http://localhost:3000/assets/images/avatar-trans.png", "is_passport_present": true }, "accompanying_guests_details": [{ "first_name": "mike", "last_name": "x2", "image": "http://localhost:3000/assets/images/avatar-trans.png", "id": 615589, "guest_type": "ADULT", "guest_type_id": 1, "is_passport_present": false }] };
