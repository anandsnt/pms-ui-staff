sntZestStation.controller('zsKeyDispenseCtrl', [
    ...
    function ($scope, $stateParams, $state, zsEventConstants, zsGeneralSrv, $filter, $timeout) {
		...
		/**
         * @returns {bool} - Whether the feature is enabled in admin
         */
        $scope.enabledInFeatureToggle = function () {
            return zsGeneralSrv.featuresToggleList && zsGeneralSrv.featuresToggleList.room_location_instructions;
        };
