sntZestStation.controller('zsThemeActionsCtrl', [
	...
	function($scope, $state, zsGeneralSrv, $timeout, zsHotelDetailsSrv) {
		...
		var getLogoSvg = function(theme) {
			...
			//
			//TODO: this needs to be moved out to svg file loading or via upload option
		...
		var getThemeName = function(theme) {
                    return 'concious';
			if (theme === 'Zoku' || theme === 'Fontainebleau' || theme === 'Yotel' || theme === 'Concious') {
