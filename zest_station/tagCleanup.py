...
with io.FileIO("cleanLocaleLog.txt", "w") as log_file:

    log_file.write(spacer)
    log_file.write(lineSpacer)
    log_file.write(datetime.datetime.now().strftime("%A, %d. %B %Y %I:%M%p"))
    log_file.write(lineSpacer)
    log_file.write(spacer)

    log_file.write(foundInHtmlHeader)
    log_file.write(spacer)
    log_file.write(TagsFoundInDirectory)
    log_file.write(lineSpacer)
    ...
    log_file.write(missingTagsHeader)
    log_file.write(spacer)
    log_file.write(MissingTagsFound)
    log_file.write(spacer)
    log_file.write(lineSpacer)

    log_file.write(notUsedInJsonHeader)
    log_file.write(spacer)
    log_file.write(unusedTags)
    log_file.write(spacer)
    log_file.write(lineSpacer)
