const ReservationComponent = ({reservation, selectReservation}) => (
    <div style={reservation.style} className={reservation.reservationClass} onClick={(e) => selectReservation(e, reservation)}>
