        ...
        options['successCallBack']([
            {
                ...
                device_id: '17',
                device_identified_name: 'Emmy',
                device_model: null,
                device_short_name: 'Emmy',
                firmware_version: '21042840G01',
                library_name: null,
                library_version: null,
                serial_number: 'B2ACA76012815AA',
                actions: [{
                    action_name: 'getLastReceipt',
                    service_name: 'getLastReceipt',
                    display_name: 'getLastReceipt'
                }]
            }]
        );
    };
