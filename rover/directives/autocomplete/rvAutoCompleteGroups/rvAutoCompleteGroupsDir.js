angular.module('sntRover').directive('autoCompleteGroups', ['RVSearchSrv', 'highlightFilter', 'rvUtilSrv',
        ...
        return {
            ...
            link: function (scope, el, attrs, ngModel) {
                ...
                var lastSearchText = "",
                    ...
                    groupsACSourceHandler = function (request, response) {
                        if (request.term.length === 0) {
                            ngModel.$setViewValue(null);
                            scope.groupName = null;
                        } else if (request.term.length > 0 && lastSearchText !== request.term) {
                            ngModel.$setViewValue(null);
                            var onSearchGroupSuccess = function (results) {
                    ...
                    }, groupsACSelectHandler = function (event, selection) {
