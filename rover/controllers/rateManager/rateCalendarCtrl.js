sntRover.controller('RateCalendarCtrl', ['$scope', '$rootScope', 'RateMngrCalendarSrv', 'dateFilter', 'ngDialog',
    function ($scope, $rootScope, RateMngrCalendarSrv, dateFilter, ngDialog) {
        ...
        $scope.scrollRatesMain = function () {
            console.log(arguments);
        };
        
        $scope.fnScroll = function () {
                $('.firstcol').scrollTop($('.table_div').scrollTop());
            };

        $scope.hasPinnedScroll = function (parentId) {

            fnAdjustTable = function () {
                console.log($('.'+parentId))//tr>td to count the columns in the row
                var colCount = $('.'+parentId).childElementCount; //get total number of column
