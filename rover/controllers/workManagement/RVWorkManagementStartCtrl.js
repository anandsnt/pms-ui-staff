angular.module('sntRover').controller('RVWorkManagementStartCtrl', ['$rootScope', '$scope', 'ngDialog', '$state', 'RVWorkManagementSrv', '$timeout',
    function($rootScope, $scope, ngDialog, $state, RVWorkManagementSrv, $timeout) {
