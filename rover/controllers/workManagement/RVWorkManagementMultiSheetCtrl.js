sntRover.controller('RVWorkManagementMultiSheetCtrl', ['$rootScope', '$scope', 'ngDialog', 'RVWorkManagementSrv', '$state', '$stateParams',
	function($rootScope, $scope, ngDialog, RVWorkManagementSrv, $state, $stateParams) {
