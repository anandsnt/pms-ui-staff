sntRover.controller('RVReservationAllCardsCtrl', ['$scope', 'RVReservationAllCardsSrv', '$timeout',
    function($scope, RVReservationAllCardsSrv, $timeout) {
        ...
        $scope.UICards = ['guest-card', 'company-card', 'travel-agent-card'];
        var init = function() {
            // TODO : Do not initiate search if creating a second reservation
        ...
        $scope.searchCompany = function() {
            ...
            if ($scope.companyName != '' || $scope.companyCity != '' || $scope.companyCorpId != '') {
                var paramDict = {
        ...
        $scope.searchTravelAgent = function() {
            ...
            if ($scope.travelAgentName != '' || $scope.travelAgentCity != '' || $scope.travelAgentIATA != '') {
                var paramDict = {
