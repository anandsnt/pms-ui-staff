sntRover.controller('RVReservationAllCardsCtrl', ['$scope', 'RVReservationAllCardsSrv', 'RVReservationCardSrv', '$timeout',
    function($scope, RVReservationAllCardsSrv, RVReservationCardSrv, $timeout) {
