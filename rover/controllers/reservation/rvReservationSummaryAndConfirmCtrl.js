sntRover.controller('RVReservationSummaryAndConfirmCtrl', ['$scope', '$state', 'RVReservationSummarySrv', 
	...
	var computeReservationDataToSave = function() {
		...
		data.adults_count = $scope.reservationData.rooms[0].numAdults;
		data.children_count = $scope.reservationData.rooms[0].numChildren;
		data.infants_count = $scope.reservationData.rooms[0].numInfants;
		data.rate_id = $scope.reservationData.rooms[0].rateId;
		data.room_type_id = $scope.reservationData.rooms[0].roomTypeId;
