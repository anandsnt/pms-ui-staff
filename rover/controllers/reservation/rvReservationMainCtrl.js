sntRover.controller('RVReservationMainCtrl', ['$scope',
        ...
        */
        ...
        $scope.callFromChildCtrl = function(baseData) {
            ...
            console.log("***callFromChildCtrl");
            console.log(baseData.demographics.markets);
            console.log(baseData.demographics.sources);
            console.log(baseData.demographics.origins);
            console.log(baseData.demographics.segments);
        ...
        var setPaymentData = function (skipPaymentData, data) {
                if (!skipPaymentData) {
                    data.payment_type = {};
            ...
            setConfirmationEmailData = function (skipConfirmationEmails, data) {
            ...
            setRoomTypes = function (data, shouldWeIncludeRoomTypeArray) {
            ...
            setRoomInfo = function (data, roomIndex) {
                data.room_id = [];
