sntRover.controller('RVArTransactionsAddCreditsControllerBkup', ['$scope', '$rootScope', 'ngDialog', 'dateFilter', 'RVCompanyCardSrv', function($scope, $rootScope, ngDialog, dateFilter, RVCompanyCardSrv) {
