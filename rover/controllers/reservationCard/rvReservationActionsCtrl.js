sntRover.controller('reservationActionsController', [
    ...
    function($rootScope,
        ...
        $scope.validateEmailPhone = function() {
            ...
            $scope.callAPI(RVGuestCardsSrv.fetchGuestDetailsInformation, {
                successCallBack: function(data) {
                    ...
                    $scope.showIdPlaceOfIssue = $scope.guestCardData.contactInfo.guestAdminSettings.id_place_of_issue.is_mandatory_on_guest_card_creation;
        ...
        $scope.popupForConfirmation = function() {
            ...
            $scope.ngData.is_custom_text_per_reservation = $scope.reservationData.reservation_card.is_custom_text_per_reservation;
