sntGuestWeb.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
	...
	$stateProvider.state('checkOutStatus', {
        url: '/checkOutStatus',
       	...
       	templateUrl: '/assets/common_templates/partials/MGM/GrandDetroit/gwCheckoutfinal.html',
		title: 'Status - Check-out Now'
   	 }).state('checkOutLaterSuccess', {
        url: '/checkOutLaterOptions/:id',
        templateUrl: '/assets/common_templates/partials/MGM/GrandDetroit/gwLateCheckoutfinal.html',
