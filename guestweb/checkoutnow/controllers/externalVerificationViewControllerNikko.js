...
*/
(function() {
	var externalVerificationViewControllerNikko = function($scope, externalVerificationService,$rootScope,$state,dateFilter,$filter,$modal) {
	...
	$scope.submit = function(){
	   ...
	   $scope.errorOpts = {
	      backdrop: true,
	      backdropClick: true,
	      templateUrl: '/assets/guestweb/checkoutnow/partials/Nikko/externalVerificationErrorModal.html',
