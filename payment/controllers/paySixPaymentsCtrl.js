angular.module('sntPay').controller('paySixPayController', [
    '$scope', 'paymentAppEventConstants', 'sntPaymentSrv', '$timeout', '$window', 'sntActivity',
    function ($scope, payEvntConst, sntPaymentSrv, $timeout, $window, sntActivity) {
