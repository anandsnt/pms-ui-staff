var admin = angular.module('admin', ['ui.router', 'ng-iscroll', 'ngDragDrop', 'ngTable','pickadate', 'ngDialog', 'ngSanitize', 'pascalprecht.translate', 'adminModuleOne', 'adminModuleTwo']);
