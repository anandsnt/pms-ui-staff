admin.controller('adHotelLegalSettingsController', 
	...
	function($rootScope, $scope, ADHotelDetailsSrv, ngDialog, $timeout) {
		...
		$scope.saveLegalSettings = function(screen) {
			...
			if (screen === 'financial') {
				unwantedKeys = ['is_print_ar_invoice_number_enabled', 'ar_invoice_number_prefix', 
								'first_ar_invoice_number', 'is_police_report_enabled', 'print_ar_invoice_number_activated_at'];
				...
				unwantedKeys = ['is_print_ar_invoice_number_enabled', 'ar_invoice_number_prefix', 'first_ar_invoice_number',
								...
								'austrian_reg_card_enabled', 'print_ar_invoice_number_activated_at'];
				...
				unwantedKeys = ['is_print_ar_invoice_number_enabled', 'ar_invoice_number_prefix', 'first_ar_invoice_number',
								...
								'print_ar_invoice_number_activated_at'];
			}
