admin.controller('ADZestLateCheckoutEmailSettingsCtrl', ['$scope', 'data', 'ngDialog', '$filter', '$controller', 'adZestEmailTemplateSrv',
	function($scope, data, ngDialog, $filter, $controller, adZestEmailTemplateSrv) {
		...
		$scope.data = data.late_checkout_email_template_settings;
		$scope.mainHeading = $filter('translate')('LATE_CHECKOUT_TEXT_SETTINGS');

		$scope.saveSettings = function() {
			var params = {
				late_checkout_email_template_settings: {
