admin.controller('adRoomDetailsCtrl', ['$timeout', '$scope', '$rootScope', 'ADRoomSrv', '$state', '$stateParams', 'availableGuestLanguages',
	function ($timeout, $scope, $rootScope, ADRoomSrv, $state, $stateParams, availableGuestLanguages) {
		/*
