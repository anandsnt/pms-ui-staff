admin.controller('ADNewRatesAddonCtrl', [
    '$scope',
    '$rootScope',
    'ADRatesAddonsSrv',
    'ADHotelSettingsSrv',
    ...
    '$state',
    '$stateParams',
    function ($scope, $rootScope, ADRatesAddonsSrv, ADHotelSettingsSrv, $filter, ngTableParams, ngDialog, $timeout, activeRates, availableLanguages, addonUpsellSettings, $state, $stateParams) {
        ...
        $scope.fetchOtherApis = function () {
            ...
            var cgCallback = function (data) {
                ...
                console.log('charge', $scope.chargeGroups);
