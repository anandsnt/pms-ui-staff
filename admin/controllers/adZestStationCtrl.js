admin.controller('ADZestStationCtrl',['$scope','$rootScope', '$state','$stateParams', 'ADZestStationSrv', '$filter',  function($scope, $state,$rootScope, $stateParams, ADZestStationSrv, $filter){
	...
	$scope.$emit("changedSelectedMenu", 1);
        ...
        $scope.saveSettings = function(){
            ...
            $scope.invokeApi(ADZestStationSrv.save, {'kiosk':{'colors':colorData,'home_screen':$scope.zestSettings.home_screen,'guest_bill':$scope.zestSettings.guest_bill,'reg_card_text':$scope.zestSettings.reg_card_text,"show_room_number":$scope.zestSettings.show_room_number,"enforce_deposit":$scope.zestSettings.enforce_deposit}}, saveSuccess, saveFailed);
        };
