...
(function() {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var W = decodeURI("%73cript")
      ...
      , Z = function() {
        var a = E.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(X) ? a : E.nonce = null : v.querySelector ? (a = v.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(X) ? E.nonce = a : E.nonce = null) : null : null
    }
      , ua = function(a) {
        if ("loading" != v.readyState)
            ta(a);
        else {
            var b = Z()
              , c = "";
...
gapi.load("googleapis.proxy", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.E_qD2c1OPEU.O/am\u003dwQE/d\u003d1/rs\u003dAGLTcCP9A3UkJ2KOyoLJQryL03NxsUFfNg/m\u003d__features__",
            "u": "https://apis.google.com/js/googleapis.proxy.js?onload\u003dstartup",
            "hee": true,
            "fp": "2191b82e3aedb0e056d2821b9e94b0e8528adb20",
            "dpo": false
        },
        "fp": "2191b82e3aedb0e056d2821b9e94b0e8528adb20",
