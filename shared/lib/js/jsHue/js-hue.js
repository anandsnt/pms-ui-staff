 ...
 */
var jsHueAPI = function jsHueAPI(fetch, Response, JSON, Promise) {
  /**
   ...
   */
  var _requestJson = function _requestJson(method, url, data) {
   ...
   * @return {Promise} promise resolving to response data object
   */
  var _requestJsonUrl = function _requestJsonUrl(method, url) {
   ...
   */
  var _parametrize = function _parametrize(method, url) {
    return function (p) {
      for (var _len = arguments.length, rest = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        rest[_key - 1] = arguments[_key];
      }

      return method.apply(undefined, [url(p)].concat(rest));
    };
  };
   ...
   */
  var _echo = function _echo(baseUrl) {
  ...
  return {
    ...
    bridge: function bridge(ip) {
      ...
      return {
         ...
         * @return {Promise} promise resolving to response data object
         */
        createUser: function createUser(type) {
          return _post(_bridgeUrl, { devicetype: type });
        },
        /**
        ...
        user: function user(username) {
          ...
          var _objectUrl = function _objectUrl(baseUrl) {
            return function (id) {
              return baseUrl + '/' + id;
            };
          };
          ...
          return {
            ...
            deleteUser: _parametrize(_delete, function (username) {
              return _configUrl + '/whitelist/' + username;
            }),
            /**
             ...
             * @return {Promise} promise resolving to response data object
             */
            searchForNewLights: function searchForNewLights() {
              var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
              return _post(_lightsUrl, data);
            },
            /**
             ...
             */
            scheduleCommandGenerator: function scheduleCommandGenerator() {
              return jsHueAPI(_echo(_baseUrl), Response, JSON, Promise).bridge(ip).user(username);
            },
             ...
             * @return {Promise} promise resolving to response data object
             */
            setSceneLightState: function setSceneLightState(sceneId, lightId, data) {
              return _put(_sceneUrl(sceneId) + '/lightstates/' + lightId, data);
            },
            /**
             * Deletes a scene.
             *
             ...
             */
            ruleActionGenerator: function ruleActionGenerator() {
              return jsHueAPI(_echo(_userUrl), Response, JSON, Promise).bridge(ip).user(username);
            },
...
if (typeof fetch !== 'undefined' && typeof Response !== 'undefined' && typeof JSON !== 'undefined' && typeof Promise !== 'undefined') {
  /**
   * jsHue class.
   *
   * @class jsHue
