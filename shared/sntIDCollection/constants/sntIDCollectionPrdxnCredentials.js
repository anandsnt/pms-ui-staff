// TODO: Will have to update the credentials once Acuant provides production credentials
angular.module('sntIDCollection').constant('productionCredentials', {
	...
	// LicenseKey: $.base64.encode("64C3503EC1C2")
});